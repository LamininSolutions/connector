...
(
    SELECT 1
    FROM [INFORMATION_SCHEMA].[ROUTINES]
    WHERE [ROUTINES].[ROUTINE_NAME] = 'spMFDeleteAdhocProperty' --name of procedure
          AND [ROUTINES].[ROUTINE_TYPE] = 'PROCEDURE' --for a function --'FUNCTION'
          AND [ROUTINES].[ROUTINE_SCHEMA] = 'dbo'
)
BEGIN
...
BEGIN
    BEGIN TRY
        ...
        (
            SELECT *
            FROM [sys].[objects]
            WHERE [objects].[object_id] = OBJECT_ID(N'[dbo].[' + @MFTableName + ']')
        ...
        BEGIN
            ...
            FROM [INFORMATION_SCHEMA].[COLUMNS] AS [c]
                ...
                (
                    ...
                    ON [list].[columnname] = [COLUMN_NAME]
            ...
            BEGIN
                ...
                DECLARE @ColumnList AS TABLE ([ColumnName] NVARCHAR(100));
                ...
                WHILE EXISTS (SELECT [ColumnName] FROM @ColumnList AS [cl])
                BEGIN
                    ...
                    SET @UpdateQuery = N'
					UPDATE tbl
					SET ' + @ColumnName + ' = null, Process_id = 1
...
*/
                ...
                BEGIN
                    ...
                    DELETE FROM @ColumnList
                    WHERE [@ColumnList].[ColumnName] = @ColumnName;
...
IF EXISTS
    (
        ...
        FROM
            [INFORMATION_SCHEMA].[ROUTINES]
        WHERE
            [ROUTINE_NAME] = 'spMFCreateAllLookups' --name of procedure
            AND [ROUTINE_TYPE] = 'PROCEDURE' --for a function --'FUNCTION'
            AND [ROUTINE_SCHEMA] = 'dbo'
    )
    BEGIN
...
/*------------------------------------------------------------------------------------------------
	Author: leRoux Cilliers, Laminin Solutions
	Create date: 2016-04
	Description: Performs Insert Update for ObjectTypClassIndex table.  only classes included in app will be updated. 
...
BEGIN TRY
    ...
    BEGIN
        ...
        SELECT @SessionID =
        (
            SELECT MAX([SessionID]) + 1 FROM [dbo].[MFAuditHistory]
        );
...
EXEC [setup].[spMFSQLObjectsControl] @SchemaName = N'dbo'
                                    ...
                                    ,@Object_Release = '3.1.7.46'             -- varchar(50)
                                    ,@UpdateFlag = 2;
-- smallint
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            SET @ProcedureStep
                = 'Checking File unique key property ' + @FileUniqueKeyColumn + ' is present in the Target class '
                  + @MFTableName;
            ...
            (
                ...
                WHERE C.TABLE_NAME = @MFTableName
                      AND C.COLUMN_NAME = @FileUniqueKeyColumn
            )
            BEGIN
...
GROUP BY ' +    QUOTENAME(@TargetFileUniqueKeycolumnName) + ' HAVING COUNT(*) > 1';
                ...
                SET @ProcedureStep = 'Importing file from source ' + @SourceTableName + ' to the m-files';
                ...
                BEGIN
                    ...
                    SET @TableWhereClause
                        = 'y.' + @TargetFileUniqueKeycolumnName + '=cast(' + @ID + 'as nvarchar(20)) and Process_Id= ' + CAST(@Process_ID AS VARCHAR(5));
                    ...
                    SET @Sql
                        = 'select @XMLOut=
							                   (  Select ' + @ID + ' as ''FileListItem/@ID'' , ' + @FileNameColumn
                          ...
                          + @SourceTableName + ' where ' + @FileUniqueKeyColumn + '=' + @ID
                          + ' FOR XML PATH('''') , ROOT(''XMLFILE'') )';
                    --      PRINT @Sql;
